...
def main():
    ...
    pre_trained_net = './pre_trained1/' + args.net_type + '_' + args.dataset + '.pth'
    ...
    netC.load_state_dict(torch.load(args.modelpath))
        ...
        in_transform = transforms.Compose([transforms.Resize(32),transforms.ToTensor(),transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
        # in_transform = transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),])
    model.cuda()
